 ...
 * Compile with:
 *
 * gcc -fPIC -ffunction-sections -fdata-sections -march=armv8-a -Os -pipe -g3 frida-core-example.c -o frida-core-example -L. -lfrida-core -ldl -lm -latomic -lrt -lpthread -lresolv -pthread -Wl,--export-dynamic,--gc-sections,-z,noexecstack -static-libgcc
 *
